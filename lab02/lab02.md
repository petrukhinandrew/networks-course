...
2. Получить продукт по его id
   ...
   - ![](images/getid-A.png)
   - ![](images/getiderr-A.png)
   - ![](images/getiderr1-A.png)
3. Обновить существующий продукт (обновляются только те поля продукта, которые были переданы в теле запроса)
   ...
   - ![](images/putputs-A.png)
   - ![](images/putkeeps-A.png)
...
Для наглядности, добавил скриншоты непосредственно к заданию. 

#### Демонстрация работы
Само решение в `rest-service`
...
После старта сервера создал 2 продукта

![](images/C0.png)

Добавил одному иконку

![](images/C1.png)

У него изменилось поле (оно соответствует имени файла в папке `resources`)
...
При удалении продукта, файл с диска тоже удалится

![](images/C4.png)

Можно сделать `PUT` вместо `POST`, чтобы добавить картинку
