...
Описание запуска в [файле](README.md)
![](images/seq-sol.png)
![](images/seq-call.png)
...
Описание запуска клиента в [файле](README.md)
...
Описание запуска клиента в [файле](README.md)
![](images/bound-sol.png)

В логах в скриншоте запись производится с промежутком в секунду только для демонстрации - можно раскомментировать 155 строку в `server/main.go` для соответствующего поведения
